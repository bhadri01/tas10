                  ...
                  <div className=" offset-lg-2 col-lg-5 col-sm-6  ">
                     <div className="row blue-zone">
                        ...
                        <div className="col-lg-7 points">
                           <div>
                              <p><img src='/assets/tick.svg' alt="tick" /> Unlimited receipt storage</p>
                              <p><img src='/assets/tick.svg' alt="tick" /> Unlimited auto-scans</p>
                              <p><img src='/assets/tick.svg' alt="tick" /> Expense report automation</p>
                              <p><img src='/assets/tick.svg' alt="tick" /> Asset Life Cycle Management</p>
                              <p><img src='/assets/tick.svg' alt="tick" /> Accounting integration </p>
                              <p><img src='/assets/tick.svg' alt="tick" /> IT asset management</p>
                           </div>
                        </div>
                     </div>
                  </div>
