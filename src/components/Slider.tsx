...
export default function ImageSlider() {
  ...
  return (
    <section className='slider-comp'>
      ...
      <img src='/src/assets/background-highlighter1.svg' className='CuHomeTabs_svgLeft__NRC_E' />
      <img src='/src/assets/background-highlighter2.svg' className='CuHomeTabs_svgRight__Cw476' />
